...
GameManager.attributes.add("camera", {
    ...
    null,
    PokiManager.instance.displayBanner(),
    this.levelStarted = !1,
    SkinsButton.instance.showButton();
    let e = this.app.assets.find("Main Menu", "template").resource.instantiate();
    return doStuffToEntity(this.app.assets.find("Main Menu", "template").resource._templateRoot, e),
    this.app.root.addChild(e),
    e.setPosition(new pc.Vec3(0, 18, 0)),
    e.findByName("Logo").findByName("LevelText").element.text = "CHAPTER " + this.levelId + "/" + 10 * Math.ceil(this.levelId / 10),
    this.start = this.app.assets.find("Pattern_Start", "template").resource.instantiate(),
    doStuffToEntity(this.app.assets.find("Pattern_Start", "template").resource._templateRoot, this.start),
    this.start.setPosition(-17.198, -2.65 - e.getPosition().y, 0),
    e.addChild(this.start),
    this.app.timeScale = 1,
    this.level && this.level.destroy(),
    this.level = e,
    this.playerController && this.playerController.entity.destroy(),
    this.spawnCharacter(),
    this.playerController.activated = !1,
    e
...
PauseButton.attributes.add("sprites", {
    ...
    null,
    this.paused = !0,
    this.previousTimeScale = this.app.timeScale,
    this.app.timeScale = 0,
    GameManager.instance.playerController.activated = !1,
    GameManager.instance.playerController.paused = !0,
    this.entity.element._image.sprite = this.homeSprite,
    this.entity.parent.findByName("PlayButton").enabled = !0
}, PauseButton.prototype.unPause = function(t) {
    null,
    this.paused = !1,
    this.app.timeScale = 1,
    this.entity.parent.findByName("PlayButton").enabled = !1,
    this.entity.element._image.sprite = this.pauseSprite,
    GameManager.instance.playerController.activated = !0,
    GameManager.instance.playerController.unPause = !0
